...
Pide al usuario  cifrar o descifrar, cuado se cifra se manda un archivo txt con la llave AES cifrada en RSA
Cuando se elige la opcion descifrar pide la llave la cual se obtiene pegando el resultado del script decrypt_rasomware
...
#Para AES-128 la longitud de llave es de 16 bytes con urandom generamos una llave aleatoria 
    ...
    print b64encode(keyAES).decode('utf-8')
