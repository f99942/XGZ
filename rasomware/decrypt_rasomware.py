...
Este script sirve para descirar la llave AES, se ejecuta en el C&C, se copia lo que imprima en pantalla
y se pega el contenido cuando se ejecuta el script rasomware al momento de descifrar pide la llave
"""
